...
public class MainTestArrayStorage {
    ...
    public static void main(String[] args) {
        ...
        // System.out.println("Exec time for sorted array storage: " + (endTime - startTime) / 1_000 + "
        // micro seconds");
        // startTime = System.nanoTime();
        System.out.println("---Unsorted array run---");
        Test(ARRAY_STORAGE);
        // endTime = System.nanoTime();
        // System.out.println("Exec time for unsorted array storage: " + (endTime - startTime) / 1_000 +
        // " micro seconds");
    }
