...
public class MainResumeTestData {
    public static Resume setTestData() {
        ...
        TextSection expLine1 = new WorkPeriodSection("Java Online Projects.", "Создание, организация ...", "10/2013", "now", "Автор проекта.");
        TextSection expLine2 = new WorkPeriodSection("Wrike.", "Проектирование и разработка ...", "10/2014", "10/2016", "Старший разработчик (backend).");
        TextSection expLine3 = new WorkPeriodSection("RIT Center.", "Организация процесса разработки ...", "04/2012", "10/2014", "Java архитектор");
        ...
        TextSection eduLine1 = new WorkPeriodSection("Coursera", "Functional Programming ...", "03/2013", "05/2013", null);
        TextSection eduLine2 = new WorkPeriodSection("Luxoft", "Курс \"Объектно-ориентированный  ...", "03/2011", "04/2011", null);
        TextSection eduLine3 = new WorkPeriodSection("Siemens AG", "3 месяца обучения мобильным ...", "01/2005", "04/2005", null);

        ListOfTextSections eduList1 = new ListOfTextSections("Санкт-Петербургский национальный ...");
        TextSection eduList1Line1 = new WorkPeriodSection("Аспирантура (программист С ...", "09/1993", "07/1996");
        TextSection eduList1Line2 = new WorkPeriodSection("Инженер (программист Fortran ...", "09/1987", "07/1993");
